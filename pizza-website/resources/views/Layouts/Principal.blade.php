...
<!-- Mirrored from yevgenysim-turkey.github.io/incline/restaurant.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Jun 2023 12:20:30 GMT -->
...
<head>
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/pizza-logo.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/pizza-logo.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets/pizza-logo.png">
    <link rel="manifest" href="assets/ico/site.webmanifest">
    <link rel="mask-icon" href="assets/ico/safari-pinned-tab.svg" color="#5bbad5">
    <link rel="shortcut icon" href="assets/pizza-logo.png">
    ...
    <title>Pizza Point - Restaurante e Pizzaria</title>
  </head>
  <body>
    ...
    {{--Inicio da parte contendo o conteudo da website--}}

    @yield('content')

    {{--Fim da parte contendo o conteudo da website--}}
